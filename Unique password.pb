...
Define Lang$ = PathConfig$ + "Lang.ini"
CompilerIf  #PB_Compiler_OS = #PB_OS_Linux
	If FileSize(Lang$) < 0 And FileSize("/usr/share/locale/" + UserIntLang$ + "/LC_MESSAGES/UniquePassword.txt") > 0
		Lang$ = "/usr/share/locale/" + UserIntLang$ + "/LC_MESSAGES/UniquePassword.txt"
	EndIf
CompilerEndIf

If OpenPreferences(Lang$) ; открываем ini
	If PreferenceGroup("Lang"); выбираем группу (секцию)
		ExaminePreferenceKeys()
		For i=1 To #CountStrLang
